...
function unitObject(data){
	...
	var r = {
		...
		animate:function(data){
			...
			if(game.user.inTransition) return false;
			...
			var frames = 20;
			var animationTime = $("body").hasClass("old") ? 0 : game.animationTime.unit;
			var that = this;
			var beforeFuncTime = $("body").hasClass("old") ? 0 : 200;
			...
			this.animation = setInterval(frameFunction, animationTime / frames)
